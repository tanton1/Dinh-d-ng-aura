...
function previewDashboard(input: { startAt?: string; endAt?: string; branchId?: string }) {
  ...
  return normalizeOperationsDashboardData({
    ...
    today: { scheduledSessions: 42, completedSessions: 27, pendingRequests: 7, attendance: { charged: 31, confirmed: 29, present: 24, late: 3, noShow: 2, pendingConfirmation: 2, attendanceRate: 93.1, confirmationRate: 93.5 } },
