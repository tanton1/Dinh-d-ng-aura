...
test('manager opportunity pool shows strict tiers and filters against learner availability on mobile', async ({ page }) => {
  ...
  await expect(officialPtSlots).toContainText('Ưu tiên 2 · PT chính thức cùng chi nhánh dưới mốc cân tải')
  ...
  await expect(page.getByText('Ưu tiên 2 · PT chính thức cùng chi nhánh dưới mốc cân tải')).toBeVisible()
